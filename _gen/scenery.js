/* SKYFALL INTERCEPTOR — desert scenery module.
   ...
   built to sit on y = 0 and translated down to GROUND_Y at draw time, so this
   file needs NOTHING from game.js at parse time — only inside init()/draw().

   Defines exactly one global: SCENERY. */
const SCENERY = (function () {
  ...
  function zk(approx) { return Math.round(L * approx / TAU) * TAU / L; }
  ...
  function gy(x, z) { var h = BASE + terr(x, z); return h < FLOORY ? FLOORY : h; }
  ...
  function pTower() {                 /* broken masonry tower */
  ...
  function pArch() {                  /* half-collapsed arch */
    var M = MB(), i;
  ...
  function pWall() {                  /* shattered curtain wall, runs along z */
    var M = MB(), i;
  ...
  function pPylon() {                 /* alien lattice mast */
    var M = MB(), i, j;
    var b = 46, t = 13, H = 320;
  ...
  function pHulk() {                  /* wrecked transport, nose buried in sand */
    var M = MB(), i, sd = 19;
  ...
  function pDish() {                  /* collapsed listening dish */
    var M = MB(), i, n = 12;
  ...
  function pMonolith() {              /* slabs stabbing out of the sand */
    var M = MB(), i, sd = 31;
  ...
  function pRubble() {                /* low scatter of blocks */
    var M = MB(), i, sd = 41;
    for (i = 0; i < 8; i++) {
  ...
  function blob(sd, r, h, n, col, col2, taper) {
    var M = MB(), i, a, rr, o = [], t = [];
    for (i = 0; i < n; i++) {
      a = i / n * TAU;
  ...
  function pRockA() { var M = blob(51, 46, 40, 6, ROCK, ROCK3, 0.55); return { d: M.d, rad: 70, h: 46 }; }
  function pRockB() { var M = blob(67, 70, 96, 7, ROCK2, ROCK, 0.42); return { d: M.d, rad: 106, h: 106 }; }

  function pSpire() {                 /* wind-carved hoodoo — cheap silhouette */
  ...
  function pButte() {                 /* big flat-topped mesa for the far field */
  ...
  function ident(o) { o[0] = o[5] = o[10] = o[15] = 1; o[1] = o[2] = o[3] = o[4] = o[6] = o[7] = o[8] = o[9] = o[11] = o[12] = o[13] = o[14] = 0; return o; }
  ...
  function pebble(M, x, y, z, rr, hh, sd, col) {
    var n = 5, i, a, o = [], t = [];
  ...
  function draw(d) {
    if (!ready) init();
    if (d === undefined) d = (typeof dist === 'number' && isFinite(dist)) ? dist : 0;
  ...
  function groundAt(x, z, d) {
    if (d === undefined) d = (typeof dist === 'number') ? dist : 0;
  ...
  return { init: init, draw: draw, groundAt: groundAt, stats: stats, PERIOD: L };
})();
